...
////////////////////////////////////////////////////////////////////////////////////////
	public DVDManager()
	{
		...
		if(!fileHandler.isFileEmpty())
			deviceList = (List<Device>) fileHandler.readFromFile(Device.class);
			else
			{
...
public void menuAddDevice()
{
	   ...
	   if(response == JOptionPane.CANCEL_OPTION)
		   ...
		   {
		   JOptionPane.showMessageDialog(null,"Data Input Error on " + e + "\nPlease Try Again");
		   }
	   	}
}
//////////////////////////////////////////////////////////////////////////////////////
...
{
	fileHandler.writeToFile(deviceList);
}
////////////////////////////////////////////////////////////////////////////////////
